 ...
 * @author GGG
 */
@WebServlet(urlPatterns = {"/Memcached"})
public class Memcached extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Memcached</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Memcached at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
            ...
            MemcachedClient mc = new MemcachedClient(servers);
